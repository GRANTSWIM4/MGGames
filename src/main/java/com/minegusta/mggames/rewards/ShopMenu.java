...
public class ShopMenu
{
    ...
    public static void openShop(Player p, boolean message)
    {
        ...
        p.openInventory(inv);
        if(message)ChatUtil.sendFormattedMessage(p, ChatColor.LIGHT_PURPLE + "You have " + ChatColor.DARK_PURPLE + Register.getPlayer(p).getTickets() + ChatColor.LIGHT_PURPLE + " tickets.", ChatColor.GRAY + "Use " + ChatColor.YELLOW +  "/Rewards " + ChatColor.GRAY + "to select your active perks.");
